...
class Part extends AppModel {
    ...
    function getKey() {
        ...
        return $notes[ mt_rand(0,sizeof($notes)-1) ];
    }
    ...
    function makeChords($key, $mode, $arrangement) {
        ...
        $flatscale    = array('A','Bb','B','C','Db','D','Eb','E','F','Gb','G','Ab');
        $sharpscale   = array('A','A#','B','C','C#','D','D#','E','F','F#','G','G#');
    ...
    function getTempo() {
        ...
        return $tempos[ mt_rand(0,sizeof($tempos)-1) ];
    }
    ...
    function getConcepts() {
        ...
        $number_words = 2; //mt_rand(1,3);

        // Get random number of random word types
        // 1=noun, 2=adjective, 3=verb, 4=adverb
        for($i=1; $i<=$number_words; $i++) {
            switch(mt_rand(1,4)) {
                case 1: $concepts[] = ucfirst($this->getNoun()); break;
                case 2: $concepts[] = ucfirst($this->getAdjective()); break;
                case 3: $concepts[] = ucfirst($this->getVerb()); break;
                case 4: $concepts[] = ucfirst($this->getAdverb()); break;
            }
        }
    ...
    function getAdverb() {
        ...
        return $adverbs[ mt_rand(0,sizeof($adverbs)-1) ];
    }
    ...
    function getNoun() {
        ...
        return $nouns[ mt_rand(0,sizeof($nouns)-1) ];
    }
    ...
    function getAdjective() {
        ...
        return $adjectives[ mt_rand(0,sizeof($adjectives)-1) ];
    }
    ...
    function getVerb() {
        ...
        return $verbs[ mt_rand(0,sizeof($verbs)-1) ];
    }
}
